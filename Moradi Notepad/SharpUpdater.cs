...
namespace Moradi_Notepad
{
    ...
    public class SharpUpdater
    {
        ...
        private void bgWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (!e.Cancelled)
            {
                ...
                if (update != null && update.IsNewerThan(this.applicationInfo.ApplicationAssembly.GetName().Version))
                {
                    ...
                    if (new SharpUpdatePrompt(this.applicationInfo, update).ShowDialog(this.applicationInfo.Context) == DialogResult.Yes)
        ...
        {
            SharpUpdateForm form = new SharpUpdateForm(update.Uri, update.MD5, this.applicationInfo.ApplicationIcon);
